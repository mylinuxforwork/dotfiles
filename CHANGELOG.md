...
- Screenshot script based on grimblast. New screenshot editor pinta added to package list. Editor can be changed in dotfiles/.settings/screenshot-editor.sh
