...
You can open the ML4W Settings app with `SUPER + CTRL + S` to change selected dotfiles configurations and choose from variations for your hyprland.conf to customize your desktop even more.
...
You can find the sourcecode in [ML4W Settings App repository](https://github.com/mylinuxforwork/dotfiles-settings)
