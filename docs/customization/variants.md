...
Open the ML4W Settings app via the ML4W Welcome App, the application launcher or the wheel icon in Waybar.
...
Please don't edit the shipped configuration variations. These will be overwritten with every update of the ML4W OS. <b>Create your own custom variation instead.</b>
...
Go back to the ML4W Settings app and select "Reload Variations" from the variation context menu and select your new variation.
